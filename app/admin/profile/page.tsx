...
export default function PageProfile() {
    ...
    return (
        <div className="flex items-center flex-col flex-1 bg-white justify-center rounded-xl border border-slate-200 p-5">
            ...
            <button
                onClick={() => router.push("/")}
                type="submit"
                className="xl: w-[368px] bg-blue-600 text-white px-4 py-2 rounded cursor-pointer"
            >
                Back to home
            </button>
        </div>
